...
{
    public class ColoredLineTool : AbstractLineTool
    {
        [SerializeField] private float brushScale = 0.02f;
        ...
        public override void InstantiateLine(CommandInvoker commandInvoker, SketchWorld sketchWorld)
        {
            ...
            ChangeLineMaterialColorTo(customColor, CurrentLineSketchObject);
        }
